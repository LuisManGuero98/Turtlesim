...
def home (xi,yi):
    ...
    velocity_message.angular.z=math.pi-0.02
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)

    desplazamiento_x(xi,2)

    velocity_message.angular.z=(math.pi/2)-0.02
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)

    desplazamiento_y(yi,2)

    velocity_message.angular.z=-(3*math.pi/2)+0.04
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
...
def go_to_goal (xgoal, ygoal):
    ...
    print('Rotacion')
    velocity_message.angular.z=(math.pi/2)-0.0125
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
    print('Desplazamiento')
    ...
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
    velocity_message.angular.z=(math.pi)-0.012
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
    print('Desplazamiento')
    ...
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
    velocity_message.angular.z=(3*math.pi/2)-0.012
    velocity_publisher.publish(velocity_message)
    time.sleep(2.0)
    print('Desplazamiento')
